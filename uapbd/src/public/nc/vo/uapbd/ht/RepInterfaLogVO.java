...
public class RepInterfaLogVO extends SuperVO{

	private static final long serialVersionUID = 8579343584972481593L;
	...
	public UFDateTime getExp_ts() {
		return exp_ts;
	}

	public void setExp_ts(UFDateTime exp_ts) {
		this.exp_ts = exp_ts;
	}
